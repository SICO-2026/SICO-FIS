...
| Rafaella Díaz  | Frontend, documentación y evidencias | README, pruebas, documentación y apoyo en frontend  | Organización del frontend, documentación de casos de prueba, evidencias de ejecución y revisión final de artefactos.          |

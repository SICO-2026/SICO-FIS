...
| SICO-08 | Interoperabilidad | Media | El sistema debe ser capaz de integrarse con servicios externos mediante APIs. |
| SICO-09 | Recuperabilidad | Alta | El sistema debe recuperar la información ante fallos sin pérdida de datos críticos. |
| SICO-10 | Testabilidad | Media | El sistema debe permitir la ejecución de pruebas funcionales básicas. |
